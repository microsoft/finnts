...
### Key Differences from Chronos2

| | Chronos2 | Chronos Bolt Base |
|---|---|---|
| External regressors | Yes (historical and future) | No |
| Global model | Yes | No (local only) |
| API credentials | CHRONOS_API_URL / CHRONOS_API_TOKEN | Same |
| Data padding | Auto-pads to 3 rows | Same |
...
### Key Differences: Chronos Model Variants

| | Chronos2 | Chronos Bolt Base | Chronos Bolt Tiny |
|---|---|---|---|
| External regressors | Yes (historical and future) | No | No |
| Global model | Yes | No (local only) | No (local only) |
| Model size | Largest | Medium | Smallest |
| Inference speed | Standard | Fast | Fastest |
| API credentials | CHRONOS_API_URL / CHRONOS_API_TOKEN | Same | Same |
| Data padding | Auto-pads to 3 rows | Same | Same |
