...
Seasonal fidelity breaks a risk-and-concern tie only when every candidate in that
tied group has a finite assessed score; otherwise WMAPE and stable ID decide the tie.
