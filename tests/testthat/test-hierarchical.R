...
test_that("prep_hierarchical_data returns correct grouped hierarchies", {
  # Mock data setup
  data <- tibble::tibble(
    Segment = c('Commercial', 'Commercial', 'Commercial', 'Commercial', 'Commercial', 'Commercial',
    ...
    Country = c('United (States)', 'United (States)', 'United (States)', 'United (States)', 'United (States)', 'United (States)',
                ...
                'UK', 'UK', 'UK', 'UK', 'UK', 'UK'),
    Product = c('Office', 'Office', 'Office', 'Excel', 'Excel', 'Excel',
                'Office', 'Office', 'Office', 'Excel', 'Excel', 'Excel',
                'Office', 'Office', 'Office', 'Excel', 'Excel', 'Excel',
                'Office', 'Office', 'Office', 'Excel', 'Excel', 'Excel'),
    Date = as.Date(c('1/1/2020', '2/1/2020', '3/1/2020', '1/1/2020', '2/1/2020', '3/1/2020',
                     '1/1/2020', '2/1/2020', '3/1/2020', '1/1/2020', '2/1/2020', '3/1/2020',
                     '1/1/2020', '2/1/2020', '3/1/2020', '1/1/2020', '2/1/2020', '3/1/2020',
                     '1/1/2020', '2/1/2020', '3/1/2020', '1/1/2020', '2/1/2020', '3/1/2020'), format="%m/%d/%Y"),
  ...
  expected_data <- tibble::tibble(
    Combo = c("Total", "Segment_Commercial", "Segment_Consumer", "Country_United_States", "Country_UK",
    ...
    Date = as.Date(c("2020-01-01", "2020-01-01", "2020-01-01", "2020-01-01", "2020-01-01",
