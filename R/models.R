...
stlm_arima <- function(train_data,
  ...
  model_spec_stlm_arima <- modeltime::seasonal_reg(
    ...
    seasonal_period_2 = if (is.na(seasonal_period_stlm_arima[2])) {
      NULL
    } else {
      seasonal_period_stlm_arima[2]
    },
    seasonal_period_3 = if (is.na(seasonal_period_stlm_arima[3])) {
      NULL
    } else {
      seasonal_period_stlm_arima[3]
    }
  ) %>%
...
stlm_ets <- function(train_data,
  ...
  model_spec_stlm_ets <- modeltime::seasonal_reg(
    ...
    seasonal_period_2 = if (is.na(seasonal_period_stlm_ets[2])) {
      NULL
    } else {
      seasonal_period_stlm_ets[2]
    },
    seasonal_period_3 = if (is.na(seasonal_period_stlm_ets[3])) {
      NULL
    } else {
      seasonal_period_stlm_ets[3]
    }
  ) %>%
...
tbats <- function(train_data,
  ...
  model_spec_tbats <- modeltime::seasonal_reg(
    ...
    seasonal_period_2 = if (is.na(seasonal_period_tbats[2])) {
      NULL
    } else {
      seasonal_period_tbats[2]
    },
    seasonal_period_3 = if (is.na(seasonal_period_tbats[3])) {
      NULL
    } else {
      seasonal_period_tbats[3]
    }
  ) %>%
